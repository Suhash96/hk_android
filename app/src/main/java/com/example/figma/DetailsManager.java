...
public class DetailsManager extends AppCompatActivity {
    ...
    private class SendUserDataToServer extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                String urlString = "https://house546.000webhostapp.com/DetailsManager.php" +
                        "?bio_id=" + encodedBioId +
                        "&name=" + encodedName +
                        "&age=" + age +
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(DetailsManager.this, "Data sent successfully", Toast.LENGTH_LONG).show();
                        }
                    });
                } else {
