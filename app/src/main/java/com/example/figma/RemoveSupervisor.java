...
public class RemoveSupervisor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remove_supervisor);
    ...
    private class DeleteSupervisorTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            try {
                ...
                URL url = new URL("https://house546.000webhostapp.com/deleteSupervisor.php?name=" + encodedName);
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
