...
public class SupervisorProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetDataTask().execute(supervisor_id);
    }
    ...
    private class GetDataTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String supervisor_id = params[0];
            String result = "";
            try {
                URL url = new URL("https://house546.000webhostapp.com/fetchSupervisorProfile.php?supervisor_id=" + supervisor_id);
