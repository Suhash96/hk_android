...
public class DetailsWorker extends AppCompatActivity {
    ...
    private class SendUserDataToServer extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                String urlString = "https://house546.000webhostapp.com/DetailsWorker.php" +
                        "?bio_id=" + encodedBioId +
                        "&name=" + encodedName +
                        "&age=" + age +
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(DetailsWorker.this, "Data sent successfully", Toast.LENGTH_LONG).show();
                        }
                    });
                } else {
