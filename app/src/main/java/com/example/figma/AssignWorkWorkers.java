...
public class AssignWorkWorkers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assign_work_workers);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedSupervisors.length() > 0) {
                    ...
                    Toast.makeText(AssignWorkWorkers.this, "No supervisors selected", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        protected void onPostExecute(JSONObject data) {
            if (data != null) {
                try {
                    ...
                    ArrayAdapter<String> buildingAdapter = new ArrayAdapter<>(AssignWorkWorkers.this, android.R.layout.simple_spinner_item, buildingNames);
                    ...
                    ArrayAdapter<String> floorAdapter = new ArrayAdapter<>(AssignWorkWorkers.this, android.R.layout.simple_spinner_item, floorNumbers);
                    ...
                    ArrayAdapter<String> roomTypeAdapter = new ArrayAdapter<>(AssignWorkWorkers.this, android.R.layout.simple_spinner_item, roomTypes);
                ...
                Toast.makeText(AssignWorkWorkers.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private class InsertAssignWorkTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                String urlString = "https://house546.000webhostapp.com/AssignWorkWorkers.php" +
                        ...
                        "&assigned_workers=" + URLEncoder.encode(selectedSupervisors, "UTF-8");
        ...
        protected void onPostExecute(String jobId) {
            if (jobId != null) {
                ...
                Intent intent = new Intent(AssignWorkWorkers.this, SupervisorJobId.class);
                intent.putExtra("job_id", jobId);
                startActivity(intent);
            } else {
                Toast.makeText(AssignWorkWorkers.this, "Failed to insert data", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
